      ...
      <VerticalTimeline>
        ...
        >
          <h5 className="vertical-timeline-element-title">
            Internship program @ Global Knowledge Technologies
          </h5>
          <h6 className="vertical-timeline-element-subtitle mt-2">
          Artificial Intelligence Tool - KNIME . 
          </h6>
          <p>• Developed Machine learning and Deep learning models through knime analytical platform.</p>
          <p>• Done dynamic data analysis with Tableau.</p>
